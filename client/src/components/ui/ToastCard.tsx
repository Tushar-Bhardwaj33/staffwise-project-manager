...
export function ToastCard({ type = "success", title, message, onClose }: ToastCardProps) {
...
const StyledWrapper = styled.div<{ $isError: boolean }>`
  ...
  .wave {
    ...
    top: 32px;
    width: 80px;
    fill: ${(props) => (props.$isError ? "#ff4d4f3a" : "#04e4003a")};
  }
  .icon-container {
    width: 35px;
    height: 35px;
    ...
    align-items: center;
    background-color: ${(props) => (props.$isError ? "#ff4d4f20" : "#04e40048")};
    border-radius: 50%;
    margin-left: 8px;
    flex-shrink: 0;
  }
  .icon {
    width: 17px;
    height: 17px;
    color: ${(props) => (props.$isError ? "#ff4d4f" : "#269b24")};
  }
  ...
  .message-text {
    color: ${(props) => (props.$isError ? "#d9363e" : "#269b24")};
    font-size: 16px;
    font-weight: 700;
  }
  .sub-text {
